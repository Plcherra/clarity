                      ...
                      delegate: SliverChildListDelegate([
                        ...
                        if (appState.uncategorizedCount > 0) ...[
                          _UncategorizedAttentionCard(
                            count: appState.uncategorizedCount,
                            onTap: () {
                              Navigator.of(context).push<void>(
                                MaterialPageRoute<void>(
                        ...
                        _ResponsiveMetricCard(
                          ...
                          value: formatMoney(appState.spentThisMonth),
                          large: false,
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.label_off_outlined, color: red, size: 28),
