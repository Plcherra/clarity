...
///
/// Lives here because it joins [BudgetRepository] data with transaction resolution
/// and dashboard scope filtering on [AppState].
extension AppStateBudgetPerformance on AppState {
  BudgetPerformanceSnapshot budgetPerformanceForScope(
    ...
    final range = budgets.budgetPeriodRangeFor(
